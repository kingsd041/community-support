...
host_ip=`/sbin/ifconfig ens3 | grep -w inet | awk  '{print $2}'`
mail_tile_failure="[FAILED] Ranher mirror download failed"
mail_tile_successful="[SUCCESS] Ranher mirror download successful ！！！"
